...
export const DATA_EXAM_EXCEPTIONS = 'exam_cmoves';
...
export const loadGridData = (gridName, args, recvfn) => {
  ...
  switch (gridName) {
    case DATA_PATIENT_EXAMS:
     ...
     ,	proc_code,	proc_desc
     from iimdb_rch${args.DbEnv.iimsReplDBNum}${args.DbEnv.iimsReplExt}..exam exm , iimdb_rch${args.DbEnv.iimsReplDBNum}${args.DbEnv.iimsReplExt}..DEPT_PROCEDURE pp  where exm.proc_id = pp.proc_id and
     exam_id in (select exam_id from iimdb_rch${args.DbEnv.iimsReplDBNum}${args.DbEnv.iimsReplExt}..EXAM_IDENTIFIER eid where eid.examid_type_code = 'ACCESSION_NBR' and eid.exam_id =
    ...
    case DATA_EXAM_EXCEPTIONS:
      dataURL = `${args.DbEnv.iimsOltp}&sqltype=customSQL&sqltext=set%20rowcount%201000%20select  exc_src_system, exc_exr_code	,exc_time , exam_id ,		exc_src_queue_id,		exc_iparam1	,exc_iparam2	,exc_iparam3	,exc_iparam4	,exc_cparam1     ,   exc_cparam2  from iimdb_rch02${args.DbEnv.iimsOltpExt}..EXCEPTION exc  where  exc.exc_exr_code in ('IMGE_SERL_A', 'IMGE_SERL_D', 'IMGE_SERL_P') and exam_id = ${args.examid} `;
      break;

    case DATA_CIGA_SERIES:
      dataURL = `${args.DbEnv.iimsOltp}&sqltype=customSQL&sqltext=set%20rowcount%201000%20select * from qrddb_rch${args.DbEnv.iimsReplDBNum}${args.DbEnv.iimsOltpExt}..CIGTB_INBOUND_SERIES inbs where inbs.patient_external_id = ${args.patientcmrn} `;
      break;
  ...
  ei.exam_id = ${args.examid} and ei.examid_type_code = 'ACCESSION_NBR' and ei.examid_value = ql.EXAM_ID and  el.SOURCE_QUEUE_ID = ql.job_queue_id
  union
  ...
  order by exception_id desc`;
    ...
    case DATA_CIGA_JOBS:
      ...
      from qrddb_rch03${args.DbEnv.iimsOltpExt}..CIGTB_JOB_QUEUE_LOG where SERIES_UID =  '${args.series_uid}'
      union
      ...
      from qrddb_rch${args.DbEnv.iimsReplDBNum}${args.DbEnv.iimsOltpExt}..CIGTB_JOB_QUEUE where SERIES_UID =  '${args.series_uid}' `;
      break;
