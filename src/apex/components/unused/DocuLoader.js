...
import ClaimsDataGrid from "../claims/ClaimsDataGrid";
...
export default class  DocuLoader extends React.Component {
...
ReactDOM.render(<DocuLoader />, document.getElementById("documgr2"));